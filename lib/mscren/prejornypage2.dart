...
class prejornypage2 extends StatefulWidget {
  String tktnum;
  String phone;
  prejornypage2({
    Key,
    required this.tktnum,
    required this.phone,
  }) : super(key: null);

  @override
  State<StatefulWidget> createState() => prejornypage2widget(tktnum, phone);
}

class prejornypage2widget extends State {
  String tktnum;
  String phone;
  prejornypage2widget(this.tktnum, this.phone);
        ...
        body: ListView(
          children: [
            Container(
                ...
                // margin: const EdgeInsets.only(to: 10),
